...
const ScheduleSection = ({ language }) => {
  ...
  const timelineData = [
    ...
    events: [
      ...
      {
         time: day_2.events.dance.time,
         title: day_2.events.dance.title,
         icon: "/icons/dance.svg",
      },
      {
          time: day_2.events.photo.time,
          title: day_2.events.photo.title,
          icon: "/icons/photobooth.svg",
        },
      {
          time: day_2.events.dinner.time,
          title: day_2.events.dinner.title,
          icon: "/icons/dinner.svg",
        },
      {
        ...
        // },
        {
          time: day_2.events.party.time,
          title: day_2.events.party.title,
