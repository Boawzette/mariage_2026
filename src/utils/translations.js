...
const translations = {
  ...
  en: {
    ...
    rsvp_section: {
      ...
      description_2: "Laissez-nous un mot en cas de régime alimentaire ou intolérance particulière ainsi que si vous avez une quelconque question. On souhaite que tout le monde passe un bon moment et soit à l'aise !",
      ...
      button: { submit: "Envoyer RSVP", loading: "Chargement..." },
    },
    registry_section: {
  ...
  schedule_section: {
    ...
    day_2: {
      ...
      events: {
        ...
        dinner2: { time: "20:00", title: "Jantar" },
